...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        CARETrans_S0, CARETrans_S1, CARETrans_S2, EfficientViM_M1, EfficientViM_M2, EfficientViM_M3, EfficientViM_M4, UniConvNet_A, UniConvNet_P0, UniConvNet_P1, UniConvNet_P2,
