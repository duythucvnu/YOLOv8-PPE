...
class OverLoCK(nn.Module):
    ...
    def __init__(self, 
        ...
        self.channel = [embed_dim[1], embed_dim[2], fushion_dim]
    ...
    def forward_features(self, x):
        ...
        p3 = self.forward_pre_features(x)
...
def overlock_xt(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
            url= 'https://github.com/LMMMEng/OverLoCK/releases/download/v1/overlock_xt_in1k_224.pth', map_location="cpu", check_hash=True)
...
def overlock_t(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
            url= 'https://github.com/LMMMEng/OverLoCK/releases/download/v1/overlock_t_in1k_224.pth', map_location="cpu", check_hash=True)
        model.load_state_dict(state_dict, strict=False)
        print(f'Load weights successfully')
...
def overlock_s(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
            url= 'https://github.com/LMMMEng/OverLoCK/releases/download/v1/overlock_s_in1k_224.pth', map_location="cpu", check_hash=True)
        model.load_state_dict(state_dict, strict=False)
        print(f'Load weights successfully')
...
def overlock_b(pretrained=None, pretrained_cfg=None, **kwargs):
    ...
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
            url= 'https://github.com/LMMMEng/OverLoCK/releases/download/v1/overlock_b_in1k_224.pth', map_location="cpu", check_hash=True)
        model.load_state_dict(state_dict, strict=False)
        print(f'Load weights successfully')
